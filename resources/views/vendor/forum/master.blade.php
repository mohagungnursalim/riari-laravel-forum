...
<div class="alert alert-warning alert-dismissible fade show" role="alert">
    <strong>Selamat Datang di TheDevcode Forum!</strong> Silahkan Login untuk bisa menambahkan post.
  </div>
@endif
    <nav class="v-navbar navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="{{ url(config('forum.web.router.prefix')) }}"><img src="{{ asset('img/logonavbartdc.png') }}" alt="logo navbar" width="140px"></a>
            ...
            <div class="collapse navbar-collapse" :class="{ show: !isCollapsed }">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url(config('forum.web.router.prefix')) }}">Forum</a>
                    </li>
                  @can('admin')
                     @can ('moveCategories')
                         <li class="nav-item">
                          <a class="nav-link" href="{{ route('forum.category.manage') }}">Manage Category</a>
                          </li>
                     @endcan
                  @endcan
